...
for iteration=400
    for x=1+dx:M-dx
        for y=1+dy:N-dy
            ...
            A1(x,y)=A1(x,y)+kk*(Da(d1,k,a)+Da(d2,k,a)+Da(d3,k,a)+Da(d4,k,a)+...
            Da(d5,k,a)+Da(d6,k,a)+Da(d7,k,a)+Da(d8,k,a));
            A2(x,y)=A2(x,y)+kk*(Db(dd1,k,a)+Db(dd2,k,a)+Db(dd3,k,a)+Db(dd4,k,a)+...
